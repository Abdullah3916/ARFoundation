...
struct ARPlacement_tA1308C1A97DE34EB044FD63BB22F99D72F2A60E7  : public MonoBehaviour_t532A11E69716D348D8AA7F854AFCBFCB8AD17F71
{
	...
	// UnityEngine.Vector3 ARPlacement::spawnPosition
	Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 ___spawnPosition_10;
};
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void ARPlacement_UpdatePlacementPose_mAA1741FB6F809237598B63C2DA26C352D5937C38 (ARPlacement_tA1308C1A97DE34EB044FD63BB22F99D72F2A60E7* __this, const RuntimeMethod* method) 
{
	...
	memset((&V_2), 0, sizeof(V_2));
	{
		...
		NullCheck(L_4);
		bool L_7;
		L_7 = ARRaycastManager_Raycast_m6D403ADB6840FC93F5C3E4C765BE1517180ED2EB(L_4, L_5, L_6, ((int32_t)15), NULL);
		...
		__this->___placementPoseIsValid_9 = (bool)((((int32_t)L_9) > ((int32_t)0))? 1 : 0);
		// if(placementPoseIsValid)
		bool L_10 = __this->___placementPoseIsValid_9;
		if (!L_10)
		{
			goto IL_009c;
		}
	}
	{
		...
		__this->___PlacementPose_7 = L_13;
		// spawnPosition = PlacementPose.position + new Vector3(0,arObjectToSpawn.transform.localScale.y / 2f,0);
		Pose_t06BA69EAA6E9FAF60056D519A87D25F54AFE7971* L_14 = (&__this->___PlacementPose_7);
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_15 = L_14->___position_0;
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_16 = __this->___arObjectToSpawn_4;
		NullCheck(L_16);
		...
		Vector3__ctor_m376936E6B999EF1ECBE57D990A386303E2283DE0_inline((&L_20), (0.0f), ((float)(L_19/(2.0f))), (0.0f), /*hidden argument*/NULL);
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_21;
		L_21 = Vector3_op_Addition_m78C0EC70CB66E8DCAC225743D82B268DAEE92067_inline(L_15, L_20, NULL);
		__this->___spawnPosition_10 = L_21;
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void ARPlacement_ARPlaceObject_m982B9B2F33AC4DDC2E37A83CD4C00D1CBC7CE76E (ARPlacement_tA1308C1A97DE34EB044FD63BB22F99D72F2A60E7* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_1 = __this->___spawnPosition_10;
		Pose_t06BA69EAA6E9FAF60056D519A87D25F54AFE7971* L_2 = (&__this->___PlacementPose_7);
		...
		__this->___spawnedObject_6 = L_4;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___spawnedObject_6), (void*)L_4);
		// }
		return;
	}
}
